  ...
  return (
    <div className='flex justify-center font-poppins bg-white '>
        <div className='max-w-[2050px] w-full flex justify-center'>
            <div className='w-[88%] my-5 2xl:mt-15 xl:mt-13 lg:mt-10 md:mt-10 flex flex-col  gap-2 2xl:gap-3 xl:gap-2 lg:gap-1.5 md:gap-3 '>
                ...
                <div className='grid gap-3 md:grid-cols-2 lg:grid-cols-4 2xl:gap-22 xl:gap-8 lg:gap-10 md:gap-7 2xl:py-12 xl:py-5 lg:py-5 md:py-2'>
                    {card.map((c, index)=>(
                        ...
                        <div key={index} className='md:bg-white p-4 m-2 sm:m-0 2xl:p-6 xl:p-5 lg:p-3 md:px-6 md:py-2 md:hover:shadow-2xl  md:hover:scale-110 rounded-lg transition-transform duration-300 ease-in-out cursor-pointer'>
