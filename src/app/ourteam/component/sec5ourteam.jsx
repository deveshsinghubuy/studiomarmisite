        ...
        <div className=' relative mt-10 w-[80%] h-[100%] mx-auto'>
          ...
          >           
            <SwiperSlide>
                ...
                <div className='pt-45 md:pt-25  pb-4 lg:p-15 bg-[#F8F6F6] mt-18 rounded-2xl '>
                  <div className='p-6 md:p-0 lg:pl-60 xl:pl-70 2xl:pl-80 flex gap-2'>
                    ...
                    <div>
                        <p className={`text-[16px] font-normal leading-8 mt-4 md:line-clamp-none ${isExpanded ? "" : "line-clamp-6"} transition-all`}>
                        ...
                        <button
                          ...
                          className="mt-2 block md:hidden text-blue-600 font-semibold hover:underline"
                        >
