  ...
  return (
    <div className='flex justify-center'>
        <div className='max-w-[2050px] relative w-full flex justify-center bg-[url("/teams/sec3rdTeams.png")] bg-center bg-cover bg-no-repeat '>
            <div className='xl:w-[80%] lg:w-[90%] w-[80%] my-10 lg:my-20 z-10  font-sans'>
                    ...
                    <div className='grid md:grid-cols-2 lg:grid-cols-3 mt-10 md:mt-7 lg:mt-15 gap-5 '>
                        {/* 1 */}
                        <div className=' flex flex-col bg-white gap-1 lg:gap-3 rounded-2xl p-8 2xl:p-16 2 py-5 '>
                            <div className='py-5'>
                            ...
                            <div className='cursor-pointer mt-4'>
                                <div className='relative'><Image className='w-[28%] custom-width custom-width2 2xl:w-[18%] md:w-[35%] lg:w-[20%] top-4 md:top-4 absolute' src="/teams/Arrow2.svg" alt='image' width={40} height={40}></Image></div>
                                <div className='w-10 h-10 relative left-8 sm:left-13 md:left-15  lg:left-7 xl:left-8 2xl:left-9 rounded-full border border-[#333333]'></div>
                            </div>
                        </div>
                        {/* 2 */}
                         <div className=' flex flex-col bg-white gap-1 lg:gap-3 rounded-2xl p-8 2xl:p-16 2 py-5   '>
